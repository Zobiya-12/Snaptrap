...
The honeypot engine **is fully functional** and captures real, live attacker traffic when deployed with open ports on a dedicated VM — see the [screen recording] *(coming soon)* and [architecture walkthrough](#architecture) below for what that looks like in practice.
